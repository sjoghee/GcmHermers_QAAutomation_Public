...
{
   [TestClass]
    public class WebPortfolioreports
    {
        IWebDriver QAReportsDriver;
        HermesBase objbase = new HermesBase();
       [TestMethod]
       public void Validate_Web_InvestmentsMonitor__Report()
       {
           try
           {
          ...
          //     QAReportsDriver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
               //objbase.WaitforPageload();
               IWebElement eleInvestorFund = QAReportsDriver.FindElement(By.Id("tabid9"));
              ...
              // QAReportsDriver.SwitchTo().Frame(frmtabview).SwitchTo().Frame("frametree1");
               ...
               IWebElement Webportfoliofund = QAReportsDriver.FindElement(By.LinkText(ConfigurationSettings.AppSettings["Webportfoliofund"]));
              ...
              /* IWebElement frmtabview1 = QAReportsDriver.FindElement(By.Name("tabview"));
               ...
               //QAReportexecutor.ExecuteScript("arguments[0].click();", eleaccfeereport);
              ...
              // QAReportsDriver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(20);
               ...
               seleportfolioid.SelectByValue(ConfigurationSettings.AppSettings["Webportfolioreportid"]);
               objbase.WaitforReportPage();

               QAReportsDriver.Quit();

           }
           catch(Exception exWebInvestmentsMonitorReport)
           {
               Console.WriteLine("Web portfolio Fund -Investor Monitor Exception: " + exWebInvestmentsMonitorReport.Message.ToString());
               QAReportsDriver.Quit();
           }
